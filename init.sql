-- init.sql
-- Este script genera los datos de prueba necesarios para poder ver todos los subforos
-- y añade un usuario administrador.

CREATE DATABASE IF NOT EXISTS foro;
USE foro;

-- Insertar subforos (usando INSERT IGNORE para no duplicar si ya existen)
